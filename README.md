...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/v7.1.0.1/geopoint-clustering-aggregation-7.1.0.1.zip`
...
| 6.8.1 | 6.8.1.0 | https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/v6.8.1.0/geopoint-clustering-aggregation-6.8.1.0.zip|
...
| 7.1.0 | 7.1.0.1 | https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/v7.1.0.1/geopoint-clustering-aggregation-7.1.0.1.zip|
