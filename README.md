...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/v6.5.1.0/geopoint-clustering-aggregation-6.5.1.0.zip`
...
| 6.5.1 | 6.5.1.0 | https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/v6.5.1.0/geopoint-clustering-aggregation-6.5.1.0.zip|
